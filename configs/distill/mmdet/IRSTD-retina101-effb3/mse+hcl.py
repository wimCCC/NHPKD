...
model = dict(
    _scope_='mmrazor',
    architecture=dict(
        cfg_path='mmdet::efficientnet/sirst_.py', pretrained=False),
    distiller=dict(
        distill_losses=dict(
            loss_pkd_fpn0=dict(loss_weight=4, type='new_PKDLoss'),
            loss_pkd_fpn1=dict(loss_weight=4, type='new_PKDLoss'),
            loss_pkd_fpn2=dict(loss_weight=4, type='new_PKDLoss'),
            loss_pkd_fpn3=dict(loss_weight=4, type='new_PKDLoss')),
...
work_dir = './work_dirs/IRSTD-retina101-effb3_mykd'
