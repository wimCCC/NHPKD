...
model = dict(
    ...
    distiller=dict(
        distill_losses=dict(
            loss_pkd_fpn0=dict(loss_weight=6, type='hcl_wo_mseLoss'),
            loss_pkd_fpn1=dict(loss_weight=6, type='hcl_wo_mseLoss'),
            loss_pkd_fpn2=dict(loss_weight=6, type='hcl_wo_mseLoss'),
            loss_pkd_fpn3=dict(loss_weight=6, type='hcl_wo_mseLoss')),
...
work_dir = './work_dirs/retinanet_hcl_wo_mse'
