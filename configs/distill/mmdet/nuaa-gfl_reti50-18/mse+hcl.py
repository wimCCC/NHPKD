...
model = dict(
    _scope_='mmrazor',
    architecture=dict(
        cfg_path='mmdet::gfl/gfl_r18.py', pretrained=False),
    distiller=dict(
        distill_losses=dict(
            loss_pkd_fpn0=dict(loss_weight=2, type='MixALoss'),
            loss_pkd_fpn1=dict(loss_weight=2, type='MixALoss'),
            loss_pkd_fpn2=dict(loss_weight=2, type='MixALoss'),
            loss_pkd_fpn3=dict(loss_weight=2, type='MixALoss')),
    ...
    teacher=dict(
        cfg_path='mmdet::gfl/gfl_r50.py', pretrained=False),
    teacher_ckpt=
    'checkpoint/teacher/gflr50e350.pth',
...
resume = False
teacher_ckpt = 'checkpoint/teacher/gflr50e350.pth'
