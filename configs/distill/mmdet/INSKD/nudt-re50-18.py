...
backend_args = None
data_root = '/home4/caiwm/NUDT-SIRST'
dataset_type = 'CocoDataset'
teacher_ckpt = 'checkpoint/teacher/NUDT_r50_e300.pth'
default_hooks = dict(
...
model = dict(
    ...
    architecture=dict(
        cfg_path='mmdet::retinanet/sirst_retinanet_r18.py',
        pretrained=False),
    teacher=dict(
...
test_evaluator = [
    dict(
        _scope_='mmdet',
        ann_file='/home4/caiwm/NUDT-SIRST/annotations/test.json',
        format_only=False,
        metric='bbox',
...
work_dir = './work_dirs/IRSTD-1k_retina50-18_ins_'
