...
default_hooks = dict(
    checkpoint=dict(_scope_='mmdet', interval=400, type='CheckpointHook'),
...
model = dict(
    ...
    distiller=dict(
        distill_losses=dict(
            loss_pkd_fpn0=dict(loss_weight=4, type='MixALoss'),
            loss_pkd_fpn1=dict(loss_weight=4, type='MixALoss'),
            loss_pkd_fpn2=dict(loss_weight=4, type='MixALoss'),
            loss_pkd_fpn3=dict(loss_weight=4, type='MixALoss')),
...
work_dir = './Ablation/IRSTD-reti_r50-a4'
